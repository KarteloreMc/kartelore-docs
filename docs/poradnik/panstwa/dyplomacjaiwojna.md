...
# Bunt
Jeśli miastu nie pasują rządy pod którymi są i nie jest ono stolicą, ma opcję buntu (w przypadku braku drugiego miasta w państwie, a będzie chęć buntu zostanie stworzone nowe miasto (na jednej prowincji do wyboru (nie może być to stolica)) i przywódcą będzie oczywiście osoba zgłaszająca bunt). Bunt podlega tym samym zasadom, co deklaracje wojenne pod względem terminów oprócz tego że cele to Wojna Totalna. Buntujące się narody mogą mieć tylko jednego sojusznika, który wspiera ich niepodległość bezpośrednio poprzez wojnę.
